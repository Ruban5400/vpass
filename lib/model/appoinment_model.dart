class AppoinmentModel {
  ...
  AppoinmentModel.fromJson(dynamic json) {
    ...
    _visitor = json['visitor'] != null
        ? VisitorAppointment.fromJson(json['visitor'])
        : null;
    _visitedBefore = json['visited_before'];
  }
  int? _status;
  VisitorAppointment? _visitor;
  String? _message;
  String? _visitedBefore;

  int? get status => _status;
  String? get message => _message;
  VisitorAppointment? get visitor => _visitor;
...
class VisitorAppointment {
  ...
  VisitorAppointment.fromJson(dynamic json) {
    _id = json['id'];
    _employeeID = json['employeeID'].toString();
