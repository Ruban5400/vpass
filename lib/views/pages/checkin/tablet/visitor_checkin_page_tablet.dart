// visitor_checkin_page_tablet.dart (Revised)

// ignore_for_file: must_be_immutable

import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart'; // Retained only for potential use in custom widgets if necessary, but removed from main layout
...
// Assuming ScreenSize is defined elsewhere (e.g., in constants.dart),
// but it's replaced here with MediaQuery for safety.
// If you still need ScreenSize, ensure it handles large screens gracefully.
...
//Gender Dropdown
  List<DropdownMenuItem<String>> get dropdownItems {
    List<DropdownMenuItem<String>> menuItems = [
      const DropdownMenuItem(
          ...
          value: '5'),
      const DropdownMenuItem( // Changed to const and removed .sp
          child: Text(
            "Female",
            style: TextStyle(
              fontWeight: FontWeight.w500,
  ...
  Widget build(BuildContext context) {
    // Helper to get screen height, assuming ScreenSize(context).mainHeight is unreliable on large screens
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center(
          child: Text(
            'visitor_details'.tr,
            style: const TextStyle( // Fixed font size
      ...
      body: GetBuilder<CheckInController>(
          ...
          builder: (controller) {
            return SingleChildScrollView(
              ...
              child: Center( // 👈 1. Center the content
                child: ConstrainedBox( // 👈 2. Constrain the maximum width
                  constraints: const BoxConstraints(
                    maxWidth: 900, // Reasonable max width for two columns on tablet/desktop
                  ),
                  child: Column( // Column to stack the InkWell content and the Loader
                    children: [
                      InkWell(
                      ...
                      // Loader is kept outside the main constraints to cover the whole screen if active
