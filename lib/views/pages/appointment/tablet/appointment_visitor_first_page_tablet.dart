...
import 'appointment_visitor_page_tablet.dart';
import '../mobile/appointment_visitor_page.dart';

class AppointmentVisitorFirstPageTablet extends StatelessWidget {
  AppointmentVisitorFirstPageTablet({Key? key}) : super(key: key);
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomLargeForm(
                            controller: appointmentController.purposeController,
  ...
  void validateAndSave(context) {
    ...
    if (form!.validate()) {
      box.read('isMobile')
          ? Get.to(AppointmentVisitorPage())
          : Get.to(AppointmentVisitorPageTablet());
    } else {
      validate = false;
    }
  }
